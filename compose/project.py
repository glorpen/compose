    ...
    def pull(self, service_names=None, ignore_pull_failures=False, parallel_pull=False, silent=False,
        ...
        if parallel_pull:
            def pull_service(service):
                strm = service.pull(ignore_pull_failures, True)
            ...
            for service in services:
                # Just unroll the generator - logs handled upstream
                [event for event in service.pull(ignore_pull_failures, silent=silent)]
